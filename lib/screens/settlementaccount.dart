...
class _SettlementAccountState extends State<SettlementAccount> {
  ...
  textFromCashOutDialog(String amount) async {
    ...
    double branchAmount = double.parse(branchWalletStore.branchWallet.balance.toStringAsFixed(2));
  ...
  void getBranchWallet()async{
    final branchWalletStore = Provider.of<BranchWalletStore>(context,listen: false);
    ...
    if(result == NetworkStrings.SUCCESSFUL){
      ...
      _accountNameController.text =
          branchWalletStore.branchWallet.accountName;
